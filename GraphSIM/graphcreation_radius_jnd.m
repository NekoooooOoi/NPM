function [G, pointset1, center, weight, radius,idx2] = graphcreation_radius_jnd(pcA, pc_fast, idx, dit, i, r_b)
...
pc_ori_coor = pcA.Location;
pc_ori_color = single(pcA.Color);
...
param.sigma = radius^2/2;
radius = r_b*radius;
param.type = 'radius';
param.epsilon = radius;
G = gsp_nn_graph(pointset1(:,1:3), param);
