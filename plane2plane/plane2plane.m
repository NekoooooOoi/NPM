function asimSym = plane2plane(pcA, pcB)
...
pcB_norm=pcnormals(pcB);
pcA=pointCloud(pcA.Location,'Color',pcA.Color,'Normal',pcA_norm);
pcB=pointCloud(pcB.Location,'Color',pcB.Color,'Normal',pcB_norm);
